...
MNIST_PATH=./datasets/mnist_folds
MNIST_FOLDS=7
MNIST_OUTPUT_PATH=./results/pretrained_weights/caes/mnist

CIFAR_PATH=./datasets/cifar_folds
CIFAR_FOLDS=6
CIFAR_OUTPUT_PATH=./results/pretrained_weights/caes/cifar
